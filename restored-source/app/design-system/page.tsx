      ...
      <AppShell>
        <NPage>
          <NPageHeader
            ...
            action={
              <NButton href="/compose" icon={Plus}>
                ساخت پست
              </NButton>
            }
          />
          ...
          <div className="grid gap-3 xl:grid-cols-[minmax(0,1fr)_360px]">
            <div className="space-y-3">
              <NSection
                title="اقدام‌ها"
                description="دکمه‌ها باید اندازه ثابت، فوکوس واضح، حالت غیرفعال و حالت بارگذاری داشته باشند."
              >
                <div className="flex flex-wrap items-center gap-2">
                  <NButton icon={Plus}>اقدام اصلی</NButton>
                  <NButton variant="secondary" icon={Filter}>
                    فیلتر
                  </NButton>
                  <NButton variant="quiet" trailingIcon={ArrowUpLeft}>
                    مشاهده جزئیات
                  </NButton>
              ...
              <NSection
                title="فرم‌ها"
                description="فرم‌ها باید کم‌ارتفاع، خوانا و مناسب لمس موبایل باشند."
              >
                <div className="grid gap-3 lg:grid-cols-3">
                  <NField
                    label="عنوان محتوا"
                    hint="حداکثر ۸۰ کاراکتر برای کارت‌های فهرست."
                    required
                  >
                    <NInput
                      icon={FileText}
                  ...
                  <NField
                    label="کلید جست‌وجو"
                    error="این مقدار در نمای عمومی تکراری است."
                  >
                    <NInput
                      state="error"
                      icon={Search}
                      placeholder="نام کمپین یا محصول"
                    />
                  </NField>
                </div>
                <div className="mt-3">
              ...
              <NSection
                title="تب‌ها و برچسب‌ها"
                description="فیلترهای تکراری باید به تب، برچسب و Saved View استاندارد تبدیل شوند."
              >
                <div className="space-y-3">
                  <NTabs
                    tabs={tabs}
                  ...
                  <div className="flex flex-wrap gap-2">
                    ...
                    <NTag tone="info" onRemove={() => undefined}>
                      کانال
                    </NTag>
                  </div>
                </div>
              ...
              <NSection
                title="ردیف‌های داده"
                description="محتوا، صف، لاگ و کمپین باید از یک زبان ردیف و اکشن استفاده کنند."
              >
                <div className="space-y-2">
                  ...
                  <NRow
                    ...
                    tone="warning"
                    meta={
                      <NStatusPill tone="warning">نیازمند بررسی</NStatusPill>
                    }
                    action={
                      <NIconButton label="تنظیمات" icon={Settings2} size="sm" />
                    }
                  />
                  <NEmptyState
                    title="ردیفی برای این نما نیست"
                    detail="با تغییر فیلتر یا ساخت محتوا، این بخش پر می‌شود."
                    icon={CheckCircle2}
                  />
                </div>
              </NSection>
            ...
            <aside className="space-y-3 xl:self-start">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-2 text-sm leading-7 text-app-muted">
                      قبل از بازسازی هر صفحه، اول باید قطعه مشترک آن در این
              ...
              <NNotice tone="info" title="پایه حرفه‌ای">
                این صفحه از V-2 به بعد مرجع کنترل کیفیت بصری است؛ اگر صفحه‌ای
                ظاهر متفاوتی بسازد، باید به این primitives برگردد.
              </NNotice>
            </aside>
          </div>
        </NPage>
