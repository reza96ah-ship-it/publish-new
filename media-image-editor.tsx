...
export function ProductMark({
  ...
  return (
    <span
      className={`relative inline-flex shrink-0 items-center justify-center overflow-hidden bg-app-primary text-white shadow-accent ${sizeClasses[size]} ${className}`}
